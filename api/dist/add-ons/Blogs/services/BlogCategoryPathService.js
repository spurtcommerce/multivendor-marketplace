...
let BlogCategoryPathService = class BlogCategoryPathService {
    ...
    findOne(blogCategoryPath) {
        return this.categoryPathRepository.findOne(blogCategoryPath);
    }
    // delete CategoryPath
    delete(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
    ...
    listByQueryBuilder(limit, offset, select = [], whereConditions = [], searchConditions = [], relations = [], groupBy = [], sort = [], count = false, rawQuery = false) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const query = yield (0, index_1.getConnection)().getRepository(BlogCategoryPath_1.BlogCategoryPath).createQueryBuilder();
            // Select
            if (select && select.length > 0) {
                query.select(select);
            }
...
BlogCategoryPathService = tslib_1.__decorate([
    (0, typedi_1.Service)(),
