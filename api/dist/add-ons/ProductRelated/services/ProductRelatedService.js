...
let ProductRelatedService = class ProductRelatedService {
    ...
    find(productRelated) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            this.log.info('find a related product');
            return yield this.productRelatedRepository.find(productRelated);
        });
    }
    ...
    listByQueryBuilder(limit, offset, select = [], whereConditions = [], searchConditions = [], relations = [], groupBy = [], sort = [], count = false, rawQuery = false) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const query = yield (0, typeorm_1.getConnection)().getRepository(ProductRelated_1.ProductRelated).createQueryBuilder();
            // Select
            if (select && select.length > 0) {
                query.select(select);
            }
